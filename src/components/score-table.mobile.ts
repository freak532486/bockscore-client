import template from "./score-table.mobile.html"
import entry from "./score-table.mobile.entry.html"
...
export class MobileScoreTableComponent implements Component
{
    ...
    public async refresh() {
        ...
        const group = this.view.querySelector(".list-group") as HTMLElement;
